          ...
          <div className='flex flex-wrap gap-5 items-center'>
            ...
            p-4 w-56 rounded-md'>
              ...
              <div>
                ...
                <p className='text-base text-gray-500 whitespace-nowrap'>Total Enrollments</p>
     ...
     <div className='flex items-center gap-3 shadow-card border border-blue-500
        ...
        rounded-md bg-white border border-gray-500/20'>
          <table className='table-fixed md:table-auto w-full overflow-hidden'>
           ...
           <tr>
            <th className='px-4 py-3 font-semibold texxt-center hidden sm:table-cell'>#</th>
            ...
            <tbody className='text-sm text-gray-500'>
              {dashboardData.enrolledStudentsData.map((item, index) => (
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  <td className='md:px-4 px-2 py-3 flex items-center spcae-x-3'>
                   <img 
