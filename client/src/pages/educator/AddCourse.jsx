        ...
        <form onSubmit={handleSubmit}  className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
          ...
          {/* Adding Chapters and Lectures */}
           <div>
              ...
              <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
               <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img src={assets.dropdown_icon} width={14} alt="" onClick={() =>
                ...
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex)=> (
                   ...
                   <img src={assets.cross_icon} alt='' onClick ={() =>handleLecture
                    ('remove', chapter.chapterId , lectureIndex)} className='cursor-pointer '   />
                  
                          
                    </div>
                  ))}
                  <div className='inline-flex bg-gray-100 p-2 rounded 
                  cursor-pointe mt-2' onClick={() => handleLecture('add' , chapter.chapterId)}>+ Add Lecture
                  </div>
                </div>
               )}
                </div>
            ...
            rounded-g cursor-pointer' onClick={() => handleChapter('add')}>+Add Chapter</div>
              ...
              bg-gray-800 bg-opacity-50'>
                ...
                max-w-80'>
                   ...
                   <div className='mb-2'>
                    ...
                    <img onClick={() => setShowPopup(false)} src={assets.cross_icon} className='
                    absolute top-4 right-4 w-4 cursor-pointer' alt="" />
